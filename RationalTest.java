...
public class RationalTest extends TestCase {
    ...
    public void testLargeEquality() {
        assertEquals(new Rational(1073741824,1), new Rational(1073741824*2,2));        
    }

    public void testAccessors() {
    	assertFalse(new Rational(1,0).numerator()==new Rational(2,0).numerator());
    }
    
    public void testAccessorsMore() {
    	assertFalse(new Rational(0,1).denominator()==new Rational(0,2).denominator());
    }
