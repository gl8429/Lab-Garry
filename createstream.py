...
class  CreateStream(webapp2.RequestHandler):        
    def post(self):
        ...
        if (len(streams)<1):
            ...
            default_context = "Notice: " + users.get_current_user().nickname() + " add a new stream named '" + stream_name +"' and the link to the stream is: "+"http://luciferlgy.appspot.com/"+stream.guesturl+"\n\n"
